...
osThreadId rconServerTaskHandle;
uint32_t rconServerTaskBuffer[ 512 ];
...
int main(void)
{
  ...
  osThreadStaticDef(rconServerTask, RconServerTask, osPriorityNormal, 0, 512, rconServerTaskBuffer, &rconServerTaskControlBlock);
  rconServerTaskHandle = osThreadCreate(osThread(rconServerTask), NULL);
